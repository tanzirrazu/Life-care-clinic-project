		...
		<div className="row container-fluid my-5 align-items-center g-5 mx-auto">
			<div className="col-md-4 col-lg-4 col-xs-12 col-sm-12">
				<div className="p-3 shadow">
					...
					<p className="text-secondary px-4 ms-3 ">
						{singleDetails[0]?.Specialty}
					</p>
					<div className="d-flex">
				...
				<button
					...
					className="btn btn-outline-dark form-control mt-3 shadow">
					Go Back
				</button>
			</div>
			<div className="col-md-8 col-lg-8 col-xs-12 col-sm-12">
				...
				<p className="text-secondary">
					On the basis of the medical center “Nordis” can be given a thorough
					examination of the body and get the advice of highly qualified
					specialists in various fields of medicine. According to studies, our
					doctors will make an individual program of prevention and treatment of
					identified diseases, directed to a surgical treatment if necessary.
				</p>
				...
				<p className="text-secondary my-5">
					...
					under local and general anesthesia; as in “Nordis” provides services
					for the diagnosis and treatment of infertility, including the use of
					reproductive technologies (IVF).
				</p>
				<h4 className="text-darl my-5 fw-bold">
				...
				<p className="text-secondary my-5">
					...
					of tourism. Managers of tourism department “Nordis” will help organize
					the passage of therapeutic and preventive measures and rehabilitation
					courses in the best health resorts of Belarus, stay in resorts and
					abroad, as well as its own tourist pearl – hotel “Nordis”, located on
					the island of Lepel lake.
				</p>
			</div>
		</div>
	);
