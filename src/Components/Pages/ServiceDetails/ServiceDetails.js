                ...
                <div>
                    ...
                    <p className="fw-bold text-secondary">{detailFound[0]?.dec}</p>
                        ...
                        <div className="bg-secondary bg-gradient p-5 text-center">
                            ...
                            <p  className="fw-bold text-white">Your local team of Client Care Managers are on call 24/7 to answer your questions and work with you to design a customized plan of care that is right for you.</p>
